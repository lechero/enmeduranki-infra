...
2. **Repository**: Clone curriculum-vitae to `/srv/curriculum-vitae`
...
sudo mkdir -p /srv
cd /srv
sudo git clone <repository-url> curriculum-vitae
sudo chown -R $USER:$USER curriculum-vitae
```

### 2. Generate Secrets

```bash
cd /srv/curriculum-vitae/apps/cms
...
Edit `/srv/curriculum-vitae/apps/cms/config/database.ts`:
...
- **CV Repository**: `/srv/curriculum-vitae`
