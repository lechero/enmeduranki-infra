...
**Deployment Location:** `/srv/apps/curriculum-vitae`
...
cd /srv/apps/curriculum-vitae/apps/cms
...
- **Main README:** `/srv/apps/curriculum-vitae/README.md`
- **CLAUDE.md:** `/srv/apps/curriculum-vitae/CLAUDE.md` (project architecture)
- **Deployment README:** `/srv/enmeduranki-infra/servers/enmeduranki/apps/kingkontext.com/README.md`
- **Production setup doc:** `/srv/apps/curriculum-vitae/state/production-deployment-setup.md`
...
# Pull code updates
cd /srv/apps/curriculum-vitae && git pull
